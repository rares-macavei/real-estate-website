  ...
  return (
    <div className="h-[25rem] sm:h-[27rem] flex bg-red-400 overflow-hidden">
      <div className="absolute  w-full z-20     ">
        <div className="bg-gray-900/40 absolute z-10 w-full h-[27rem]  "></div>
        <img
          src={houses}
      ...
      <div className="relative z-30 flex flex-col items-center w-full pt-12">
        ...
        <div className="relative mt-9  ">
          <input
            type="search"
            className="bg-white py-4  w-[22rem] sm:w-[32rem] rounded-full pl-5 placeholder:text-gray-500 placeholder:text-[20px] outline-0 "
